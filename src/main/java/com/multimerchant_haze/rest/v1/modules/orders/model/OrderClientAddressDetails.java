 ...
 */
@Entity
@Table(name = "order_client_address_details")
public class OrderClientAddressDetails implements Serializable
{
    @Id
    ...
    public OrderClientAddressDetails()
    {

    }

    public OrderClientAddressDetails(ClientAddressDTO clientAddressDTO)
    {
    ...
    public String toString()
    {
        ...
        sb.append("Order Client Address Details Entity");
        sb.append("[");
        sb.append("OrderID: ");
